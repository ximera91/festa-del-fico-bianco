    ...
    public class PlaneDiscoveryGuide : MonoBehaviour
    {
        ...
        private void _UpdateUI()
        {
                ...
                Session.LostTrackingReason != LostTrackingReason.None)
            {
                ...
                switch (Session.LostTrackingReason)
                {
                    case LostTrackingReason.InsufficientLight:
                        m_SnackBarText.text = "Troppo buio. Prova a spostarti in un'area più illuminata.";
                        break;
                    case LostTrackingReason.InsufficientFeatures:
                        m_SnackBarText.text = "Punta il telefono verso una superficie più dettagliata";
                        break;
                    case LostTrackingReason.ExcessiveMotion:
                        m_SnackBarText.text = "Ti muovi troppo veloce. Vai più piano.";
                        break;
                    default:
                        m_SnackBarText.text = "Tracciamento del movimento perduto.";
                        break;
                }
            ...
            if (m_NotDetectedPlaneElapsed > DisplayGuideDelay)
            {
                ...
                {
                    m_SnackBarText.text = "Hai bisogno di aiuto?";
                    m_OpenButton.SetActive(true);
                }
                else
                {
                    m_SnackBarText.text = "Punta la fotocamera dove vuoi posizionare un oggetto.";
                    m_OpenButton.SetActive(false);
                }
            }
